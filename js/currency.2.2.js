...
function loadCSVList(){
	...
	(async () => {
		...
		htmlString += '<csv>currency_12.1.2021.csv</csv>';
		...
		htmlString += '<csv>currency_3.1.2022.csv</csv>';
		htmlString += '<csv>currency_2.1.2022.csv</csv>';
		htmlString += '<csv>currency_1.1.2022.csv</csv>';
		htmlString += '</response>';	
