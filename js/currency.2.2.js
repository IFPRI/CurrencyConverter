...
function loadCSVList(){
	...
	(async () => {
		...
		htmlString += '<csv>currency_6.1.2024.csv</csv>';
		htmlString += '<csv>currency_5.1.2024.csv</csv>';
		htmlString += '<csv>currency_4.1.2024.csv</csv>';
		htmlString += '<csv>currency_3.1.2024.csv</csv>';
