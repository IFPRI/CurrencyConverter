...
function loadCSVList(){
	...
	(async () => {
		...
		htmlString += '<csv>currency_12.1.2024.csv</csv>';
        htmlString += '<csv>currency_11.1.2024.csv</csv>';
		htmlString += '<csv>currency_10.1.2025.csv</csv>';
		htmlString += '<csv>currency_9.1.2025.csv</csv>';
		htmlString += '<csv>currency_8.1.2025.csv</csv>';
		htmlString += '<csv>currency_7.1.2025.csv</csv>';
		htmlString += '<csv>currency_6.1.2025.csv</csv>';
		htmlString += '<csv>currency_5.1.2025.csv</csv>';
		htmlString += '<csv>currency_4.1.2025.csv</csv>';
		htmlString += '<csv>currency_3.1.2025.csv</csv>';
		htmlString += '<csv>currency_2.1.2025.csv</csv>';
		htmlString += '<csv>currency_1.1.2025.csv</csv>';
		htmlString += '</response>';	
